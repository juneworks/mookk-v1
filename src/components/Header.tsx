  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white border-b border-[#1C4025]/10">
      ...
      <div className="w-full bg-[#1C4025] py-1.5 px-4 text-center">
        <Link href="/about" className="inline-flex items-center justify-center gap-1.5 text-xs sm:text-sm font-semibold text-white hover:text-[#FFDD33] transition-colors">
